...
test-all: ## run pytest, doctests, examples
	pytest --cov=deeplearning --cov-report html
	pytest --cov=deeplearning --cov-report html --cov-append scripts/*_example.py
	pytest --cov-report html --cov=deeplearning --cov-append --doctest-modules deeplearning/
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs_source/deeplearning.rst
	rm -f docs_source/modules.rst
	sphinx-apidoc -o docs_source/ deeplearning
